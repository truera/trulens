...
payload = {"title": "Fix for issue #2496", "body": "Closes #2496\n\nImplemented automated fix.", "head": "KartavyaDikshit:fix-issue-2496", "base": "main"}
req = urllib.request.Request("https://api.github.com/repos/truera/trulens/pulls", data=json.dumps(payload).encode(), headers={'Authorization': f'token {token}', 'Accept': 'application/vnd.github.v3+json', 'Content-Type': 'application/json'}, method='POST')
try:
