...
class AxiomsTestBase(object):
    ...
    def setUp(self):
        ...
        self.model_lin_bias = np.random.uniform(-0.5, 0.5,
                                                (self.output_size, ))
        ...
        self.model_deep_bias_1 = np.random.uniform(-0.5, 0.5,
                                                   (self.internal1_size, ))
        ...
        self.model_deep_bias_2 = np.random.uniform(-0.5, 0.5,
                                                   (self.internal2_size, ))
        ...
        self.model_deep_bias_3 = np.random.uniform(-0.5, 0.5,
                                                   (self.output_size, ))
    ...
    def test_idempotence(self):
        infl = InternalInfluence(self.model_lin,
                                 InputCut(),
                                 MaxClassQoI(),
                                 PointDoi(),
        ...
        infl_act = InternalInfluence(self.model_lin,
                                     InputCut(),
                                     MaxClassQoI(),
                                     PointDoi(),
    ...
    def test_linear_agreement_multiply_activation(self):
        ...
        self.assertTrue(
            np.allclose(res,
                        self.model_lin_weights[:, c] * self.x,
                        atol=ALLCLOSE_ATOL))

    def test_linear_agreement_linear_slice(self):
        c = 4
        infl = InternalInfluence(self.model_deep,
    ...
    def test_distributional_linearity(self):
        ...
        infl_pt = InternalInfluence(self.model_deep,
                                    InputCut(),
                                    ClassQoI(0),
                                    PointDoi(),
                                    multiply_activation=False)
        ...
        infl_dl = InternalInfluence(self.model_deep,
                                    InputCut(),
                                    ClassQoI(0),
                                    DistLinDoI(x2 - x1),
                                    multiply_activation=False)
    ...
    def test_completeness_internal(self):
        ...
        infl = InternalInfluence(self.model_deep,
                                 Cut(self.layer2),
                                 ClassQoI(c),
                                 LinearDoi(baseline=baseline,
                                           resolution=100,
                                           cut=Cut(self.layer2)),
                                 multiply_activation=True)

        g = partial(self.model_deep.fprop,
