"""
This file contains only deprecated classes and should not be used except for
migrating from very old versions of trulens_eval.
"""
...
class LocalSQLite(DB):
    ...
    def insert_feedback_definition(
        ...
        feedback_str = feedback_definition.model_dump_json()
