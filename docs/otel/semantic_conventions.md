...
| `ai.observability.generation` | Namespace for attributes specific to LLM generation calls. | | Y | |
| `ai.observability.generation.model_name` | Name of the model used for generation. | Never | | str |
| `ai.observability.generation.input_messages` | Input messages sent to the model. | Never | | str |
| `ai.observability.generation.output_message` | Output message generated by the model. | Never | | str |
| `ai.observability.generation.prompt_tokens` | Number of tokens in the prompt. | Never | | int |
| `ai.observability.generation.completion_tokens` | Number of tokens in the completion. | Never | | int |
