...
Compares wall-clock time for:
  - run.start() with invocation_max_workers=1 (sequential) vs default (parallel)
  - run.compute_metrics() with metric_max_workers=1 (sequential) vs default (parallel)
...
up to 18 miles wide, and over a mile deep.
"""
zion_info = """
...
if __name__ == "__main__":
    print("=" * 60)
    print("BENCHMARK: Parallel vs Sequential Run APIs")
