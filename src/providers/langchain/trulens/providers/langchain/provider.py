...
def _convert_message(
    message: Union[Dict, langchain_messages.BaseMessage],
) -> langchain_messages.BaseMessage:
    """Convert a message to a LangChain BaseMessage."""
    if isinstance(message, langchain_messages.BaseMessage):
        return message
...
class Langchain(llm_provider.LLMProvider):
    ...
    def _create_chat_completion(
        ...
        messages: Optional[
            Sequence[Union[Dict, langchain_messages.BaseMessage]]
        ] = None,
        ...
        **kwargs,
        ...
        if prompt is not None:
            ...
            lc_messages: list[langchain_messages.BaseMessage] = [
